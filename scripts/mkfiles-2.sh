...
cp /configuration/cardano/shelley_qa-alonzo-genesis.json "${ROOT}/shelley_qa.alonzo.spec.json"
...
mv ${ROOT}/genesis.conway.spec.json ${ROOT}/genesis.conway.spec.json.tmp && cat ${ROOT}/genesis.conway.spec.json.tmp | jq '. += {"genDelegs":{}}' > ${ROOT}/genesis.conway.spec.json && rm ${ROOT}/genesis.conway.spec.json.tmp
